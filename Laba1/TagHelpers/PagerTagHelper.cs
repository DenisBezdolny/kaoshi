...
namespace Laba1.TagHelpers
{
    public class PagerTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)

         {
            ...
            for (int i = 1; i <= PageTotal; i++)
            {
                ...
                // получение разметки одной кнопки пейджера var item =
        ...
        /// <param name="text">текст кнопки пейджера</param> /// <param
        //name="active">признак текущей страницы</param> /// <param
        //name = "disabled" > запретить доступ к кнопке</param> ///
