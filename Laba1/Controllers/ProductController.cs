...
namespace Laba1.Controllers
{
    public class ProductController : Controller
    {
        ...
        //    {
        //        new Dish {DishId = 1, DishName="Суп-харчо",Description="Очень острый, невкусный", Calories =200, DishGroupId=3, Image="Суп-харчо.jpg" },
        //        new Dish { DishId = 2, DishName="Борщ", Description="Немного сала, со сметаной",Calories =330, DishGroupId=3, Image="Борщ.jpg" },
        //        new Dish { DishId = 3, DishName="Котлета пожарская", Description="Хлеб - 80%, Морковь - 20%",Calories =635, DishGroupId=4, Image="Котлета пожарская.jpg" },
        //        new Dish { DishId = 4, DishName="Макароны по-флотски", Description="С охотничьей колбаской", Calories =524, DishGroupId=4, Image="Макароны по-флотски.jpg" },
