...
namespace Laba1.Tests
{
    ...
    public class ProductControllerTests
    {
        ...
        public void ControllerGetsProperPage(int page, int qty, int id)
        {
            ...
            var controllerContext = new ControllerContext(); // Макет  HttpContext
            ...
            using (var context = new ApplicationDbContext(_options))
            {
                ...
                // Act
                var result = controller.Index(group: null, pageNo: page) as
                ViewResult;
        ...
        public void ControllerSelectsGroup()
        {
            ...
            using (var context = new ApplicationDbContext(_options))
            {
                ...
                // act
                var result = controller.Index(2) as ViewResult; var model =
                result.Model as List<Dish>;
                // assert
